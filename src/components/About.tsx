...
export function About({ cafeSummary }: AboutProps) {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">Every dish and drink is crafted with passion and attention to detail.</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">We source the finest, freshest ingredients from local suppliers.</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">A welcoming space where neighbors become friends over great food.</p>
          </div>
        </div>
      </div>
    </section>
